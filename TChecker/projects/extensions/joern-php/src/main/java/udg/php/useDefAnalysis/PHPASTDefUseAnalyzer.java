...
public class PHPASTDefUseAnalyzer extends ASTDefUseAnalyzer
{
	 ...
	 */
	@Override
	protected UseDefEnvironment createUseDefEnvironment(ASTProvider astProvider, boolean isCompact)
	{
		String nodeType = astProvider.getTypeAsString();
...
//			case "CallExpressionBase":
			...
			case "CallExpressionBase" :
				CallExpressionBaseEnvironment caenv = new CallExpressionBaseEnvironment();
				caenv.setDefArguments(astProvider.getChild(0));
				return caenv;
			...
			*/
			...
			case "ArgumentList":
				ArgumentListEnvironment alenv = new ArgumentListEnvironment(isCompact);
				return alenv;
